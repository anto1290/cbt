...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() . 'assets/select2/select2-bootstrap.min.css'; ?>">
    <!-- JS sweetalert2-->
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <?php
                        $super = $this->session->userdata('level');
                        if ($super == "Super") { ?>
                            <a class="collapse-item" href="<?= base_url('Admin/admList'); ?>">Admin Lits</a>
                        <?php } ?>
                        <a class="collapse-item" href="<?= base_url('Admin/Guru'); ?>">Guru</a>
                        <a class="collapse-item" href="<?= base_url('Admin/info_sekolah'); ?>">Informasi</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('Admin/print'); ?>">Print</a>
                        <a class="collapse-item" href="<?= base_url('Admin/mengajar'); ?>">Mengajar</a>
                        <a class="collapse-item" href="<?= base_url('Admin/ganti_password'); ?>">Forgot Password</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Other Pages:</h6>
                        <a class="collapse-item" href="<?= base_url('admin/phpinfo'); ?>">php info</a>
                        <a class="collapse-item" href="<?= base_url('admin/delci'); ?>">Clear History</a>
                    </div>
                </div>
            </li>
