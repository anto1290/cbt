...
<div class="container-fluid">
    ...
    <form id="updateTest" action="<?= base_url() . 'siswa/test_update' ?>" method="post">
        ...
        <input type="hidden" name="idsiswa" value="<?= $jawaban->nis; ?>">
        ...
        <?php } else { ?>
            ...
            <legend><?php echo "$soal"; ?></legend>
        <?php } ?>
        <textarea class="form-control" name="jawaban" id="jawaban" cols="30" rows="10"><?= $jawaban->Jawaban_esai; ?></textarea>
        <br>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        if ($uri4 < $jmlhalaman) { ?>
                            <button style="width:180px;" type="button" id="nextup" class="btn btn-success">Next <i class="fas fa-arrow-alt-circle-right"></i></button>
                            ...
                            if ($cekRagu == 0) { ?>
                                <button type="button" style="width:180px;" class="btn btn-primary tombol-selesai"><a class="finishTime"></a>Finish <i class="fas fa-check-circle"></i></b>
                                <?php } else { ?>
